...
[Create an Issue](https://github.com/JadejaHQ/docs/issues) on our GitHub repository.
...
[Feature Request](https://github.com/JadejaHQ/docs/discussions/new?category=ideas) on our GitHub
repository.
...
[Discuss Pull Request](https://github.com/JadejaHQ/docs/discussions/new?category=pull-request) it.

<br>

## Contribute

1. [Fork The Repository](https://github.com/JadejaHQ/docs/fork).
   - If already forked, then sync the `dev` branch
2. [Create an Issue](https://github.com/JadejaHQ/docs/issues) or
   [Feature Request](https://github.com/JadejaHQ/docs/discussions/new?category=ideas) if not exist.
3. Follow Branch naming conventions
   ...
   - > For example, <br> If issue (feature request) url is
     > https://github.com/JadejaHQ/docs/issues/11, <br> then your branch name must be `feat-11`
...
[LICENSE](https://github.com/JadejaHQ/docs/blob/main/LICENSE) file.

---

Thank you for your time 🙂

_Last updated on June 3, 2026_
